...
contract ISharedRoyaltyToken is IERC721 {
     ...
     */
    function franchisorBalanceOf(address _franchisor)
        public
        view
        returns (uint256);
     ...
     */
    function franchisorWithdrawPaymentsLeft(
        address _franchisor,
        uint256 _tokenId
     ...
     * @param _tokenId The identifier for an NFT
     */
    function withdrawPayment(address payable _franchisor, uint256 _tokenId)
        public;
     ...
     * @return uint256 representing the balance in wei accumulated for a token
     */
    function paymentBalanceOf(address _franchisor, uint256 _tokenId)
        public
        view
        returns (uint256);
}
