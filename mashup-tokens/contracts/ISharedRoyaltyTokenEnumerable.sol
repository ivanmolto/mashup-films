...
contract ISharedRoyaltyTokenEnumerable {
     ...
     */
    function tokenFranchisorsTotal(uint256 _token)
        public
        view
     ...
     */
    function tokenFranchisorsByIndex(uint256 _index, uint256 _token)
        public
        view
        returns (address franchisor);
     ...
     */
    function tokenPaymentsTotal(uint256 _token)
        public
        view
        returns (uint256 count);
     ...
     */
    function tokenPaymentsByIndex(uint256 _index, uint256 _token)
        public
        view
     ...
     */
    function tokensOfFranchisorByIndex(uint256 _index, address _franchisor)
        public
        view
